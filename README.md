...
- [aoctimer-linux64-v3.0.4.zip](https://github.com/caderek/aoctimer/releases/download/v3.0.4/aoctimer-linux64-v3.0.4.zip)
- [aoctimer-macos-v3.0.4.zip](https://github.com/caderek/aoctimer/releases/download/v3.0.4/aoctimer-macos-v3.0.4.zip)
- [aoctimer-windows64-v3.0.4.zip](https://github.com/caderek/aoctimer/releases/download/v3.0.4/aoctimer-windows64-v3.0.4.zip)
...
You can also use it locally, invoking it by pointing to it's location, for example:

```sh
~/home/utils/aoctimer

C:\User\me\tools\aoctimer.exe
```
